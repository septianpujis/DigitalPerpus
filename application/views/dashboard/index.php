...
<div class="panel panel-default">
    ...
    <div class="row">
        <div class="col-lg-12">Dashboard</div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="row">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">Anggota</div>
                                <div>Anggota Tetap</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div><h2>Pengembalian</h2></div>
                                <div>Kembalikan Buku</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="panel panel-danger2">
                    ...
                    <a href="<?php echo base_url('dashboard/logout') ?>" class="text-danger2">
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                            <div class="clearfix"></div>
